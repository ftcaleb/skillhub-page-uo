                ...
                <Link href={`/events/${event.slug}`} className="block h-full">
                  <div className="relative h-full overflow-hidden rounded-2xl border border-border/50 bg-card p-6 lg:p-8 transition-all duration-500 hover:shadow-xl hover:shadow-primary/[0.04] hover:border-border">
                    ...
                    <div className="flex items-start justify-between">
                      <span className={`inline-flex rounded-full border px-3 py-1 text-[10px] font-semibold uppercase tracking-wide ${colorClass}`}>
                        {event.skillLevel}
                      </span>
                    ...
                    <h3 className="mt-5 text-lg font-semibold text-foreground leading-snug line-clamp-2">
                      {event.title}
                    </h3>
