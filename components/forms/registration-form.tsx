            ...
            <Card className="rounded-3xl border border-border/50 bg-card shadow-lg shadow-primary/5">
                <CardHeader className="p-8 pb-4">
                    <CardTitle className="text-3xl font-bold tracking-tight">
                        Register for <span className="text-accent">{eventTitle}</span>
                    </CardTitle>
                    <CardDescription className="text-lg mt-2">
                        Complete your registration details below. We look forward to seeing you there!
                    </CardDescription>
                </CardHeader>
                        ...
                        {isSuccess ? (
                            ...
                            >
                                ...
                                <p className="text-muted-foreground mt-2 max-w-sm">
                                    You've successfully registered for {eventTitle}. We'll send a confirmation email with all the details shortly.
                                </p>
                                <Button
                                    variant="outline"
                                        ...
                                        <FormField
                                            ...
                                            render={({ field }) => (
                                                <FormItem>
                                                    ...
                                                    <FormControl>
                                                        <Input type="number" min={1} {...field} className="h-12 rounded-xl border-border/60 bg-muted/30 focus-visible:ring-accent/30" />
                                                    </FormControl>
                                                    <FormMessage />
                                                </FormItem>
                                            )}
